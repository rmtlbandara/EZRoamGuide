...
export const infoPages: InfoPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Advertising and Google AdSense", paragraphs: ["This website may use Google AdSense if advertising is enabled in the future. Third-party vendors, including Google, may then use cookies or similar technologies to serve and measure ads on this website.", "Google's use of advertising cookies enables Google and its partners to serve personalized ads based on a user's visit to this website and other websites, or non-personalized ads based on factors such as general location and the current page.", "Users can opt out of personalized advertising through Google Ads Settings and can also manage or delete cookies through their browser settings. EZ Roam Guide may use analytics and advertising technologies to understand website usage and support site operations. EZ Roam Guide does not sell personal information."], links: [{ label: "Manage Google ad personalization", href: "https://adssettings.google.com/" }, { label: "How Google uses information from sites and apps", href: "https://policies.google.com/technologies/partner-sites" }] },
