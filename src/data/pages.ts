...
export const infoPages: InfoPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Advertising and Google AdSense", paragraphs: ["This website may use Google AdSense if advertising is enabled in the future. Third-party vendors, including Google, may then use cookies or similar technologies to serve and measure ads on this website.", "Google's use of advertising cookies enables Google and its partners to serve personalized ads based on a user's visit to this website and other websites, or non-personalized ads based on factors such as general location and the current page.", "Users can opt out of personalized advertising through Google Ads Settings and can also manage or delete cookies through their device or web settings. EZ Roam Guide may use analytics and advertising technologies to understand website usage and support site operations. EZ Roam Guide does not sell personal information."], links: [{ label: "Manage Google ad personalization", href: "https://adssettings.google.com/" }, { label: "How Google uses information from sites and apps", href: "https://policies.google.com/technologies/partner-sites" }] },
      { heading: "Retention, security, and rights", paragraphs: ["Information is retained only as reasonably needed for operations, legal obligations, security, and correspondence. No internet service can promise absolute security.", "Depending on where you live, you may have rights to request access, correction, deletion, restriction, or objection. Contact ezroamguide@gmail.com with a clear request. We may need to verify identity without collecting unnecessary data."] },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Updates and corrections", paragraphs: ["Guide pages show a last-updated date. An update may address facts, links, structure, clarity, accessibility, or the usefulness of the arrival sequence.", "Readers can report a possible error at ezroamguide@gmail.com. We assess reliable evidence, correct material errors, and avoid retaining a claim merely because it once ranked well."] },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Managing cookies", paragraphs: ["Your device or web settings can block or delete cookies, though doing so can affect some website functions. Device controls may also limit advertising identifiers or cross-site tracking.", "Google Analytics and advertising preferences can also be managed through Google's controls. If advertising is enabled, an appropriate consent management platform will be used where Google policy or applicable law requires it."], links: [{ label: "Google privacy controls", href: "https://myaccount.google.com/data-and-privacy" }, { label: "Google Ads Settings", href: "https://adssettings.google.com/" }] },
      { heading: "Questions", paragraphs: ["Contact ezroamguide@gmail.com with questions about this policy. For broader information about personal data, read the Privacy Policy.", "External websites linked from our guides set their own cookies and are governed by their own policies."] }
    ]
  }
];
