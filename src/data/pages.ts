...
export const infoPages: InfoPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Analytics and advertising", paragraphs: ["The initial site does not include active Google AdSense code. If analytics or advertising services are added later, this policy and the cookie controls will be updated before or when those services are enabled.", "Third-party advertising services may use cookies or similar technologies to measure ads and limit repetition. Where required, consent choices will be provided."] },
  ...
  },
  {
    ...
    sections: [
      { heading: "Current use of cookies", paragraphs: ["The initial static site does not require an account and does not intentionally set advertising cookies. The hosting platform may use essential security or delivery mechanisms according to its own documentation.", "Because no active AdSense code is included, the empty future ad positions do not load ads, track readers, or display blank boxes."] },
      { heading: "Possible future categories", paragraphs: ["Essential technologies support security, routing, and preferences. Analytics technologies help understand aggregate site use. Advertising technologies may measure, personalize, or limit repetition of ads.", "If non-essential technologies are introduced, the site will provide notices or consent choices where required by applicable law. This policy will be updated to identify material providers and purposes."] },
      { heading: "Managing cookies", paragraphs: ["Browser settings can block or delete cookies, though doing so can affect some website functions. Device and browser controls may also limit advertising identifiers or cross-site tracking.", "Consent, where offered, can be changed through the site's preference control. At launch there is no non-essential cookie preference panel because the site does not load those services."] },
